...
import csrdDB from '../write/CSRD-Temp.json' assert { type: 'json' }
...
const updateCollectionKeys = ["foci",]
...
console.log("writing")
     writeFileSync('../../json/write/CSRD-UPDATE.json', JSON.stringify(compendium, replacer), 'utf8');
